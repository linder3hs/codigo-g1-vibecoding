...
/**
 * Task form validation schema - Complete version for TaskForm component
 */
export const taskSchema = z.object({
  ...
  tags: z
    .array(z.string().min(1, "Las etiquetas no pueden estar vacías"))
    .optional()
    .default([]),
...
/**
 * Simple task schema for basic forms (backward compatibility)
 */
...
export const taskFiltersSchema = z.object({
  ...
  sortBy: z
    .enum(["createdAt", "priority", "text"], {
      message: "Selecciona un criterio de ordenamiento",
    })
    .default("createdAt"),
...
export type SimpleTaskFormData = z.infer<typeof simpleTaskSchema>;
